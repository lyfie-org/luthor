...
export const metadata: Metadata = {
  title: {
    default: "Luthor - Free Open Source Rich Text Editor",
    template: "%s | Luthor",
  },
  description:
    "Luthor is a free, open-source, modern rich text editor built for React developers. Features drag-and-drop blocks, customizable extensions, and seamless integration with Lexical framework.",
  keywords: [
    "rich text editor",
    "React editor",
    "Lexical editor",
  ...
  metadataBase: new URL("https://luthor.lyfie.app"),
  alternates: {
    canonical: "/",
  },
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://luthor.lyfie.app",
    title: "Luthor - Free Open Source Rich Text Editor",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Luthor - Modern Rich Text Editor",
      },
    ],
  },
  twitter: {
  ...
  other: {
    ...
    "application-name": "Luthor Editor",
  },
};
