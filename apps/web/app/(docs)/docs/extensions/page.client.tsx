    ...
    <div className="space-y-12">
      ...
      <div className="text-center space-y-6 py-8">
        <div className="text-center">
          ...
          <p className="text-xl text-muted-foreground mt-2">
            Extend Luthor with powerful custom functionality
          </p>
        </div>
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          Learn how to build type-safe extensions that seamlessly integrate with
          Luthor's editor system. From simple commands to complex UI components,
          unlock the full potential of your editor.
        </p>
      ...
      <div className="space-y-6">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-center leading-relaxed">
          Extensions are modular pieces of functionality that enhance your
          Luthor editor. They provide commands, state queries, UI components,
          and custom behavior.
        </p>
        ...
        <div className="flex flex-col md:grid md:grid-cols-3 gap-4 md:gap-6">
          <Card className="border-primary/20">
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                Define actions that users can trigger. Commands are strongly
                typed and accessible through the editor's command palette and
                toolbar.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-primary/20">
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                Query the current state of your editor. Use these to
                enable/disable buttons, show contextual UI, or make decisions
                based on content.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-primary/20">
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                Add toolbar buttons, floating panels, context menus, and other
                UI elements that integrate seamlessly with your editor.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      <div className="space-y-6">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-center leading-relaxed">
          Let's break down what makes up a Luthor extension.
        </p>
        ...
        <div className="space-y-8">
          ...
          <Card className="border-blue-200 dark:border-blue-800 bg-gradient-to-br from-blue-50/50 to-purple-50/50 dark:from-blue-950/20 dark:to-purple-950/20">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                Every extension starts with the <code>createExtension</code>{" "}
                function. This factory function creates a strongly typed
                extension instance with proper TypeScript support.
              </p>
              <SimpleCodeBlock
          ...
          <div className="flex flex-col md:grid md:grid-cols-2 gap-4 md:gap-6">
            <Card className="border-blue-200 dark:border-blue-800">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Define the actions your extension provides. Each command is a
                  function that receives the Lexical editor instance and
            ...
            <Card className="border-blue-200 dark:border-blue-800 max-w-full">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Define functions that return information about the editor's
                  current state. These are async functions that can read from
                  the editor safely.
                </p>
                <SimpleCodeBlock
      ...
      <div className="space-y-6">
        <div className="text-center space-y-3">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Interactive demo of the functional approach. Click the buttons to
        ...
        <DynamicCodeExample
          ...
          codes={[
            "docs/extensions/examples/TestExtension.tsx",
            "docs/extensions/examples/BasicEditorWithCustomExtension.tsx",
          ]}
      ...
      <div className="space-y-6">
        <div className="text-center">
          ...
          <p className="text-lg text-muted-foreground mt-4 max-w-2xl mx-auto">
            The object-oriented approach - ideal for complex extensions with
            inheritance
          </p>
        </div>
        ...
        <div className="space-y-8">
          <Card className="border-green-200 dark:border-green-800 bg-gradient-to-br from-green-50/50 to-emerald-50/50 dark:from-green-950/20 dark:to-emerald-950/20">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                The BaseExtension class provides a more traditional class-based
                approach to creating extensions. This is perfect for complex
                extensions that need inheritance or shared state.
              </p>
          ...
          <div className="flex flex-col md:grid md:grid-cols-2 gap-4 md:gap-6">
            <Card className="border-green-200 dark:border-green-800">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Implement the <code>getCommands</code> method to return your
                  extension's command functions. Each command receives the
                  Lexical editor instance and performs operations.
                </p>
                <SimpleCodeBlock
            ...
            <Card className="border-green-200 dark:border-green-800">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Implement the <code>getStateQueries</code> method to return
                  async functions that query the editor's current state safely
                  using <code>editor.read()</code>.
                </p>
                <SimpleCodeBlock
                  html={
                    getHighlightedCode("base-extension-state-queries") || ""
                  }
      ...
      <div className="space-y-6">
        <div className="text-center space-y-3">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Interactive demo of the class-based approach. Same functionality,
        ...
        <DynamicCodeExample
          ...
          codes={[
            "docs/extensions/examples/TestBaseExtension.tsx",
            "docs/extensions/examples/BasicEditorWithBaseExtension.tsx",
          ]}
      ...
      <div className="space-y-6">
        <div className="text-center space-y-3">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            <strong>Universal Integration:</strong> No matter which approach you
            choose to create your extensions, the integration process is exactly
            the same. Both createExtension and BaseExtension extensions work
            identically in your editor system.
          </p>
        ...
        <div className="space-y-6">
          <Card className="border-purple-200 dark:border-purple-800">
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Create a const assertion array containing your extensions. The
                process is identical regardless of how you created your
                extensions - both approaches work the same way.
              </p>
          ...
          <Card className="border-purple-200 dark:border-purple-800">
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Use the <code>createEditorSystem</code> function to generate a
                typed Provider and useEditor hook based on your extensions. The
                process is identical for both approaches.
              </p>
              <div className="bg-muted rounded-lg overflow-hidden">
          ...
          <Card className="border-purple-200 dark:border-purple-800">
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Wrap your editor with the Provider and use the useEditor hook to
                access commands and state queries from your extensions. Works
                the same way for both approaches.
              </p>
              <SimpleCodeBlock
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-4 md:gap-6">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                Leverage TypeScript's power. Define clear interfaces for your
                commands and state queries. This prevents runtime errors and
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                Always return a cleanup function from your initialize method.
                This ensures event listeners and other resources are properly
                disposed of.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                ...
                for mutations. Avoid unnecessary re-renders and optimize state
                queries.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                Document your extension's API clearly. Include JSDoc comments
                for commands and state queries to help other developers
