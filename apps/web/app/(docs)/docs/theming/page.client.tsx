    ...
    <div className="max-w-4xl mx-auto space-y-12">
      ...
      <div className="text-center space-y-6 py-8">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          Customize every aspect of your Luthor editor with powerful theming
      ...
      <div className="space-y-6">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-center leading-relaxed">
          Luthor's theming system builds on Lexical's foundation while adding
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Luthor Custom Properties</CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
      ...
      <div className="space-y-6">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-center leading-relaxed">
          Upgrading from plain Lexical themes to Luthor theming.
        </p>

        <Card>
          <CardHeader>
            <CardTitle>From Lexical to Luthor</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              ...
              <div>
                <h4 className="font-semibold mb-2">After (Luthor)</h4>
                <SimpleCodeBlock
                  title="Luthor theme configuration with extensions"
