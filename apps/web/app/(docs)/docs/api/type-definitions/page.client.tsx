    ...
    <div className="max-w-4xl mx-auto space-y-12">
      ...
      <div className="text-center space-y-6 py-8">
        <div className="text-center">
          ...
          <p className="text-xl text-muted-foreground mt-2">
            Complete TypeScript reference for Luthor
          </p>
        </div>
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          Comprehensive TypeScript definitions that power Luthor's type-safe
          architecture. Understand the core interfaces, generics, and utility
          types that make Luthor type-safe.
        </p>
      ...
      <div className="space-y-6">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-center leading-relaxed">
          Luthor's type system is built around several key concepts that work
      ...
      <div className="space-y-6">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-center leading-relaxed">
          How Luthor's advanced type system improves your development
          experience.
        </p>
