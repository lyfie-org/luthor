...
- Combined with Lexical defaults, common dropdown languages include `TypeScript`, `JavaScript`, `Python`, `Java`, `C/C++`, `Rust`, `Swift`, `SQL`, `PowerShell`, `HTML`, `CSS`, `Markdown`, and `XML`.
