...
export const DEMO_EXTENSIVE_CONTENT = documentToJSONString([
...
export const DEMO_COMPOSE_CONTENT = documentToJSONString([
...
export const DEMO_SIMPLE_EDITOR_CONTENT = documentToJSONString([
  paragraphNode([
...
export const DEMO_LEGACY_RICH_CONTENT = markdownToJSONString(LEGACY_RICH_MARKDOWN_SOURCE);
...
export const DEMO_SLASH_EDITOR_CONTENT = documentToJSONString([
