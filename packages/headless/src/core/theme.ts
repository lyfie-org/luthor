...
export const defaultLuthorTheme: LuthorTheme = {
  ...
  code: "luthor-code-block prism-code",
  codeHighlight: {
    atrule: "token atrule luthor-code-atrule",
    attr: "token attr-name luthor-code-attr",
    boolean: "token boolean luthor-code-boolean",
    builtin: "token builtin luthor-code-builtin",
    cdata: "token cdata luthor-code-cdata",
    char: "token char luthor-code-char",
    class: "token class-name luthor-code-class",
    "class-name": "token class-name luthor-code-class-name",
    comment: "token comment luthor-code-comment",
    constant: "token constant luthor-code-constant",
    deleted: "token deleted luthor-code-deleted",
    doctype: "token doctype luthor-code-doctype",
    entity: "token entity luthor-code-entity",
    function: "token function luthor-code-function",
    important: "token important luthor-code-important",
    inserted: "token inserted luthor-code-inserted",
    keyword: "token keyword luthor-code-keyword",
    namespace: "token namespace luthor-code-namespace",
    number: "token number luthor-code-number",
    operator: "token operator luthor-code-operator",
    prolog: "token prolog luthor-code-prolog",
    property: "token property luthor-code-property",
    punctuation: "token punctuation luthor-code-punctuation",
    regex: "token regex luthor-code-regex",
    selector: "token selector luthor-code-selector",
    string: "token string luthor-code-string",
    symbol: "token symbol luthor-code-symbol",
    tag: "token tag luthor-code-tag",
    url: "token url luthor-code-url",
    variable: "token variable luthor-code-variable",
  },
